...
#         plot(slice_coordinates, population_timepoint(solution, 1, time_dx)[slice_dxs...];
...
#             plot!(slice_coordinates, population_timepoint(solution, i_pop, time_dx)[slice_dxs...]; label=pop_names[i_pop], kwargs...)
#         end
#     end
# end
